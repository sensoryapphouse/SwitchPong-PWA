...
Pong = {
    Defaults: {
        ...
        height: 960, // logical canvas height
        wallWidth: 18,
        paddleWidth: 24,
        paddleHeightL: 120, // size of paddle default 60
        paddleHeightR: 120, // size of paddle default 60
        paddleSpeed: 2, // should be able to cross court vertically   in 2 seconds
        ballSpeed: 2, // default speed is 4
        ballAccel: 8, // ... but accelerate as time passes
        ballRadius: 25, // size of ball defult 5
        singleSwitch: 0, // one or two switches
        holdSwitch: 1, // able to hold switc down or just tap it
        sound: true
    },
...
//    "images/press2.png",
    ...
    goal: function (playerNo) {
        ...
        if (this.scores[playerNo] == 9) {
            ...
            this.stop();
            // showMenu();
            if (Pong.Colors.leftpaddle == 'white')
                Restart(0);
            else if (Pong.Colors.rightpaddle == 'white')
                Restart(2);
            else
                Restart(3);
        } else {
    ...
    draw: function (ctx) {
        ...
        Pong.Colors.paddles = Pong.Colors.leftpaddle;
        this.leftPaddle.draw(ctx);
        Pong.Colors.paddles = Pong.Colors.rightpaddle;
    ...
    onkeydown: function (keyCode) {
        switch (keyCode) {
            ...
            case Game.KEY.P:
            case Game.KEY.TWO:
            case Game.KEY.PAGEUP:
                if (!this.rightPaddle.auto)
                    this.rightPaddle.moveUp();
                break;
            case Game.KEY.L:
            case Game.KEY.FOUR:
            case Game.KEY.PAGEDOWN:
                if (!this.rightPaddle.auto)
    ...
    Menu: {
        ...
        initialize: function (pong) {
            var winner = pong.images["images/winner.gif"];
            this.winner1 = {
                image: winner,
    ...
    Sounds: {
        ...
        initialize: function (pong) {
            ...
            if (this.supported) {
                ...
                //                    applause: Game.createAudio("sounds/goal.wav"),
                //                };
            }
        },

        play: function (name) { // PB change this to use PlaySound initialised on keypress
    ...
    Paddle: {
        ...
        initialize: function (pong, rhs) {
            ...
            if (rhs)
                this.height = pong.cfg.paddleHeightR;
            else
                this.height = pong.cfg.paddleHeightL;
            this.minY = pong.cfg.wallWidth;
            this.maxY = pong.height - pong.cfg.wallWidth - 2 * this.height;
        ...
        draw: function (ctx) {
            ctx.fillStyle = Pong.Colors.paddles;
    ...
    Ball: {
        ...
        update: function (dt, leftPaddle, rightPaddle) {
            ...
            if (pt) {
                ...
                // add/remove spin based on paddle direction: PB remove this as option?
                //                if (paddle.up)
